...
export default function ChapaPaymentReceiptBanner({ receipt, onDismiss }: Props) {
  ...
  return (
    <div
      role="status"
      className="mb-8 rounded-2xl border border-neutral-border/30 dark:border-primary-blue/30 bg-neutral-border/15 dark:bg-primary-blue/10 p-6 shadow-sm"
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex gap-4">
          <div className="w-12 h-12 rounded-xl bg-primary-blue flex items-center justify-center shrink-0">
            <CheckCircle2 className="text-black w-7 h-7" />
          </div>
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-primary-blue dark:text-neutral-border mb-1">
              Payment receipt
            </p>
        ...
        <button
          type="button"
          onClick={onDismiss}
          className="p-2 rounded-lg hover:bg-neutral-border/25 dark:hover:bg-primary-blue/20 text-gray-500 transition-colors shrink-0"
