      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10">
        <div className="lg:col-span-3 space-y-6">
          <div className="bg-white dark:bg-[#111] rounded-[2rem] p-6 md:p-10 shadow-sm border border-gray-100 dark:border-white/5">
            ...
            <div className="bg-neutral-border/15/60 dark:bg-primary-blue/10 border border-neutral-border/25 dark:border-primary-blue/20 rounded-2xl p-5 mb-6">
              <div className="flex items-center gap-3">
                <ShieldCheck size={18} className="text-primary-blue dark:text-neutral-border shrink-0" />
            ...
            <button
              ...
              className="w-full bg-primary-blue hover:bg-neutral-border text-black py-4 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-primary-blue/25 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isProcessing ? (
                <>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white dark:bg-[#111] rounded-[2rem] p-6 md:p-8 shadow-sm border border-gray-100 dark:border-white/5 lg:sticky lg:top-28">
            ...
            <div className="rounded-2xl bg-linear-to-br from-primary-blue/10 to-transparent border border-neutral-border/25 dark:border-primary-blue/20 p-5 mb-6">
              <p className="text-[10px] font-black uppercase tracking-widest text-primary-blue dark:text-neutral-border mb-2">
                You receive
              </p>
              <div className="flex items-center gap-3">
            ...
            <div className="space-y-3 text-sm mb-6 pb-6 border-b border-gray-100 dark:border-white/5">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-primary-blue">ETB (Birr)</span>
              </div>
              <div className="flex justify-between">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-2xl font-black text-primary-blue">{formatBirr(packDetails.price)}</span>
            </div>
