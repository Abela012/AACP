      ...
      >
        <div className="p-8 pb-4">
          <Link to="/dashboard/admin" className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-black uppercase tracking-tight text-[#1A1D1F] dark:text-white leading-none">
                Admin Panel
              </h1>
              ...
              return (
                ...
                >
                  <item.icon
                    ...
                    className={cn(
                      "transition-colors",
                      isActive ? "text-primary-blue" : "text-[#9A9FA5]",
                    )}
                  />
                  {item.name}
                  {isActive && (
        ...
        <header className="h-20 bg-white/80 dark:bg-[#0A0A0A]/80 backdrop-blur-lg px-8 flex items-center justify-between sticky top-0 z-40 border-b border-[#EFEFEF] dark:border-white/5">
          <div className="flex items-center gap-6">
            ...
            <div className="hidden md:flex flex-col">
              <h2 className="text-lg font-bold text-[#1A1D1F] dark:text-white leading-none mb-1">
                AACP Admin
              </h2>
          ...
          <div className="flex items-center gap-4">
                ...
                {showNotifications && (
                  ...
                  >
                    <div className="p-6 border-b border-[#EFEFEF] dark:border-white/5 flex justify-between items-center bg-gray-50/50 dark:bg-white/[0.02]">
                      <h3 className="font-bold text-[#1A1D1F] dark:text-white">
                        Notifications
                      </h3>
                      {unreadCount > 0 && (
                      ...
                      {notifications.length > 0 ? (
                        notifications.map((notif) => (
                          ...
                          >
                            ...
                            <div>
                              <p className="text-sm font-bold text-[#1A1D1F] dark:text-white mb-1">
                                {notif.title}
                              </p>
                              <p className="text-xs text-[#6F767E] dark:text-gray-400 leading-relaxed mb-2">
                                {notif.message}
                              </p>
                        ...
                        <div className="p-10 text-center">
                          <Bell
                            className="mx-auto text-[#9A9FA5] dark:text-gray-700 mb-3"
                            size={32}
                          />
            ...
            <Link
              to="/admin/settings"
              className="w-10 h-10 flex items-center justify-center text-[#6F767E] hover:text-[#1A1D1F] transition-all"
            >
              <Settings size={20} />
            </Link>
            ...
            <Link
              to="/admin/profile"
              className="flex items-center gap-3 ml-4 pl-4 border-l border-[#EFEFEF] dark:border-white/5 hover:opacity-80 transition-opacity"
            >
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[10px] font-bold text-primary-blue uppercase tracking-widest leading-none">
                  Profile
                </p>
              </div>
