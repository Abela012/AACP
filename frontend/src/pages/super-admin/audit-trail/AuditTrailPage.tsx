      ...
      <div className="max-w-[1400px] mx-auto pb-12 space-y-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex gap-3">
            ...
            <button className="px-5 py-3 bg-primary-blue hover:bg-primary-blue text-white rounded-2xl text-xs font-black uppercase tracking-widest shadow-lg shadow-neutral-border/25 dark:shadow-none flex items-center gap-2">
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-6 px-8">
                          ...
                          <div className="text-[10px] font-black uppercase tracking-widest text-primary-blue">
                            {l.actorRole}
                          </div>
                        </td>
                        <td className="py-6 px-8">
