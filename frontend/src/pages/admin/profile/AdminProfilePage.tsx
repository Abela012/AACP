  ...
  useEffect(() => {
    if (profile && !isLoading) {
      const name = profile.firstName
        ...
        : clerkUser?.fullName || "Administrator";
      setProfileName(name);
      setTempName(name);
      setProfileImage(
        profile.avatarUrl ||
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-[#111111] p-8 rounded-[3rem] border border-[#EFEFEF] dark:border-white/5 shadow-sm text-center relative overflow-hidden group">
              ...
              <p className="text-[10px] font-black text-primary-blue uppercase tracking-widest mb-6">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-white text-xs font-bold rounded-xl transition-all shadow-md dark:shadow-none ${
                      is2FAEnabled
                        ...
                        : "bg-primary-blue hover:bg-primary-blue shadow-neutral-border/25"
                    }`}
                  >
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <label className="text-[10px] font-black text-[#9A9FA5] uppercase">
                            Old Password
                          </label>
                          <input
                            type="password"
