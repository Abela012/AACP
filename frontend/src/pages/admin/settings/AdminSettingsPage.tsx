  ...
  return (
    <button
      ...
      className={`w-14 h-7 rounded-full relative transition-all duration-200 shrink-0 ${
        enabled ? (danger ? 'bg-red-500' : 'bg-primary-blue') : 'bg-gray-200 dark:bg-white/10'
      }`}
    >
      <span
    ...
    <AdminLayout>
      <div className="max-w-[1200px] mx-auto pb-24">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-6 mb-8">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-blue/10 text-primary-blue text-[10px] font-black uppercase tracking-widest mb-3">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-primary-blue text-white rounded-2xl text-xs font-bold hover:bg-primary-blue transition-all shadow-lg shadow-neutral-border/25 dark:shadow-none disabled:opacity-50"
            >
        ...
        <div className="flex flex-wrap gap-2 p-1.5 bg-[#F8F8FD] dark:bg-white/5 rounded-2xl border border-[#EFEFEF] dark:border-white/5 mb-8">
          {TABS.map(({ id, label, icon: Icon }) => (
            ...
            >
              <Icon size={14} className={activeTab === id ? 'text-primary-blue' : ''} />
              {label}
            </button>
          ))}
        </div>
              ...
              <div className="space-y-6">
                <section className="bg-white dark:bg-[#111111] rounded-[2rem] border border-[#EFEFEF] dark:border-white/5 shadow-sm p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between gap-6 p-5 rounded-2xl bg-[#F8F8FD] dark:bg-white/5 border border-transparent hover:border-[#EFEFEF] dark:hover:border-white/10 transition-all">
                      <div className="flex gap-4 flex-1 min-w-0">
                        <div className="w-11 h-11 rounded-2xl bg-primary-blue/10 text-primary-blue flex items-center justify-center shrink-0">
                          <UserPlus size={20} />
                        </div>
                        <div>
                    ...
                    <div className="p-5 rounded-2xl bg-[#F8F8FD] dark:bg-white/5 border border-transparent hover:border-[#EFEFEF] dark:hover:border-white/10 transition-all">
                      ...
                      <input
                        ...
                        className="w-full max-w-xs rounded-2xl border border-[#EFEFEF] dark:border-white/10 bg-white dark:bg-black/30 px-4 py-3 text-sm font-bold text-[#1A1D1F] dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-blue/30"
                      />
                    </div>
                  </div>
                </section>
                        ...
                        <div className="flex justify-between items-start mb-4">
                          <div
                            className={`w-12 h-12 rounded-2xl flex items-center justify-center border ${
                              ok
                                ? 'bg-neutral-border/15 dark:bg-primary-blue/10 text-primary-blue border-neutral-border/25 dark:border-primary-blue/20'
                          ...
                          <div className="flex items-center gap-1.5">
                            <div className={`w-2 h-2 rounded-full ${ok ? 'bg-primary-blue' : 'bg-amber-500 animate-pulse'}`} />
                            <span
                              className={`text-[10px] font-black uppercase tracking-widest ${
                                ok ? 'text-primary-blue dark:text-neutral-border' : 'text-amber-600 dark:text-amber-400'
                              }`}
                            >
          ...
          {showSaveBar && (
            ...
            >
              ...
              <button
                ...
                className="px-4 py-2 bg-primary-blue text-white rounded-xl text-xs font-bold hover:bg-primary-blue disabled:opacity-50"
              >
                {saveMutation.isPending ? 'Saving…' : 'Save changes'}
              </button>
            </motion.div>
