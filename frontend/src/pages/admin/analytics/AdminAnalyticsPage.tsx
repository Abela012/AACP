      ...
      <AdminLayout>
        <div className="flex items-center justify-center h-96">
          <div className="text-center">
            <Loader2 size={48} className="text-primary-blue animate-spin mx-auto mb-4" />
          ...
          <div className="flex gap-3 relative">
              ...
              {['1M', '3M', '1Y'].map((range) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${
                    timeRange === range ? 'bg-white dark:bg-white/10 shadow-sm text-primary-blue' : 'text-[#6F767E] hover:text-[#1A1D1F]'
                  }`}
                >
                  {range}
                </button>
            ...
            <div className="relative">
              <button
                ...
                className="px-5 py-2.5 bg-primary-blue text-white rounded-2xl text-xs font-bold hover:bg-primary-blue transition-all shadow-lg shadow-neutral-border/25 dark:shadow-none flex items-center gap-2"
              >
          ...
          {overviewStats.map((stat, idx) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <div className={`flex items-center gap-1 text-xs font-bold ${stat.up ? 'text-primary-blue' : 'text-amber-500'}`}>
