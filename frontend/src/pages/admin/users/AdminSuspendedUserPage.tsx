      ...
      <div className="max-w-[1400px] mx-auto pb-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-aacp-olive">Agency Partner</span>
              <span className="text-gray-300 dark:text-white/10">•</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-aacp-olive bg-aacp-gold/15 dark:bg-aacp-olive/10 px-1.5 py-0.5 rounded flex items-center gap-0.5">
              ...
              <div>
                ...
                <div className="flex items-center justify-center gap-1 mb-1">
                  ...
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} size={14} className={i < 4 ? "text-aacp-olive fill-current" : "text-gray-200 dark:text-gray-800"} />
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#111111] p-8 rounded-[3rem] border border-[#EFEFEF] dark:border-white/5 shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center p-4 bg-[#F4F4F4]/50 dark:bg-white/5 rounded-2xl border border-[#EFEFEF] dark:border-white/5">
                  ...
                  <button className="text-[10px] font-black text-aacp-olive uppercase hover:underline flex items-center gap-1">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-aacp-gold/20 dark:bg-white/5 p-8 rounded-[3rem] border border-white dark:border-white/5 shadow-inner">
              <h3 className="font-black text-xl mb-10">Administrative Actions</h3>

              <div className="space-y-4 mb-10">
                <button className="w-full p-6 bg-linear-to-tr from-aacp-olive to-aacp-olive text-white rounded-3xl flex items-start gap-4 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-aacp-gold/25 dark:shadow-none text-left">
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <textarea
                    className="w-full h-32 bg-white/50 dark:bg-white/5 border border-[#EFEFEF] dark:border-white/10 rounded-2xl p-4 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-aacp-olive/20 transition-all resize-none italic"
        ...
        <div className="mt-12 bg-gray-50 dark:bg-white/5 p-6 rounded-4xl border border-[#EFEFEF] dark:border-white/5">
          <div className="flex flex-wrap items-center gap-8 text-[10px] font-bold uppercase tracking-widest text-[#6F767E] dark:text-gray-400">
            ...
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-aacp-olive" />
