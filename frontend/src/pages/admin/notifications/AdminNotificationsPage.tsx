        ...
        <div className="bg-white dark:bg-[#111111] p-8 rounded-[3rem] border border-[#EFEFEF] dark:border-white/5 shadow-sm">
          {isLoading ? (
            <div className="py-20 text-center">
              <Bell className="w-10 h-10 text-primary-blue mx-auto mb-4 animate-pulse" />
            ...
            <div className="py-20 text-center">
              ...
              <button
                type="button"
                onClick={() => refetch()}
                className="mt-4 text-xs font-bold text-primary-blue hover:underline"
              >
                Try again
              </button>
            </div>
                    ...
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${
                        notif.priority === 'high'
                          ...
                          : 'bg-green-50 dark:bg-green-500/10 text-primary-blue'
