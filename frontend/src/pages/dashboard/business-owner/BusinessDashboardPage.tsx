...
const Card = ({
  ...
  <div
    className={cn(
      "aacp-card overflow-hidden",
      cardVariantClass[variant] ?? "aacp-card--panel",
      className,
    )}
  >
    {(title || extra) && (
...
export default function BusinessDashboardPage() {
  ...
  const activeOpps = opportunities.filter(
    (o: Opportunity) => o.status === "open",
  );
  const totalApplicants = opportunities.reduce(
    (acc: number, opp: Opportunity) => acc + (opp.applicants?.length ?? 0),
    0,
  );
  ...
  return (
    <BusinessLayout>
      <main className="p-4 md:p-8 max-w-400 mx-auto w-full space-y-8 pb-20">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Your profile is being verified. Some features might be
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Your balance is below 100 AACP. Top up to ensure your
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-black text-gray-900 dark:text-white">
              Business <span className="text-primary-blue">Command Center</span>
            </h1>
            <p className="text-sm text-gray-500 mt-1">
              Manage your advertisement ecosystem and track performance
              real-time.
            </p>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              ...
              value: trustScoreLoading
                ...
                : trustScoreValue !== null
                  ...
                  : "N/A",
              trend:
                trustScoreValue !== null && trustScoreValue >= 70
                  ? "Good standing"
                  : "Build your score",
              trendType:
                trustScoreValue !== null && trustScoreValue >= 70
            ...
            <motion.button
              ...
              className="bg-white dark:bg-[#111] p-6 rounded-4xl border border-gray-100 dark:border-white/5 shadow-sm hover:border-primary-blue/30 transition-all group text-left"
            >
              <div className="flex justify-between items-start mb-4">
                <div
                  className={cn(
                    "w-12 h-12 rounded-2xl flex items-center justify-center bg-gray-50 dark:bg-white/5",
                    stat.color,
                  )}
                >
                  <stat.icon size={24} />
        ...
        {/* 3. QUICK ACTIONS BAR */}
        <div className="flex flex-wrap gap-4 p-6 bg-primary-blue rounded-3xl shadow-xl shadow-primary-blue/20 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-6 w-full">
            <div className="flex-1">
              ...
              <p className="text-white/70 text-sm">
                Jump into your most frequent tasks immediately.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <Card
              ...
              extra={<Badge variant="danger">{realTasks.length} Pending</Badge>}
            >
              <div className="space-y-4">
                {realTasks.length === 0 ? (
                  ...
                  realTasks.map((task) => (
                    <div
                      key={task.id}
                      className="flex items-center justify-between p-4 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/5 group hover:border-primary-blue/30 transition-all"
                    >
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-white dark:bg-white/10 text-gray-900 dark:text-white rounded-xl text-xs font-bold border border-gray-100 dark:border-white/10 group-hover:bg-primary-blue group-hover:text-white transition-all"
                      >
                        {task.action}
                      </button>
                    </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="p-4 bg-neutral-border/15 dark:bg-primary-blue/5 rounded-2xl border border-neutral-border/25 dark:border-primary-blue/20">
                  ...
                  <p className="text-xs text-gray-500">
                    {topCampaign
                      ? `${topCampaign.fillRate}% applicant fill rate`
                      : "0% applicant fill rate"}
                  </p>
                </div>
                <div className="p-4 bg-red-50 dark:bg-red-500/5 rounded-2xl border border-red-100 dark:border-red-500/20 opacity-70">
                  ...
                  <p className="text-xs text-gray-500">
                    {lowestCampaign
                      ? `${lowestCampaign.fillRate}% applicant fill rate`
                      : "0% applicant fill rate"}
                  </p>
                </div>
              </div>
            ...
            <Card
              ...
              extra={
                <button className="text-xs font-bold text-primary-blue hover:underline">
                  View All
                </button>
              }
            >
                    ...
                    {isLoadingOpps ? (
                      <tr>
                        <td colSpan={5} className="py-8 text-center">
                          <Loader2 className="animate-spin mx-auto text-primary-blue" />
                        </td>
                      </tr>
                          ...
                          <td className="py-5 text-right">
                            <div className="flex justify-end gap-2">
                              <button
                                ...
                                className="p-2 bg-white dark:bg-white/5 rounded-xl border border-gray-100 dark:border-white/10 text-gray-400 hover:text-primary-blue transition-all"
                              >
                                <Edit size={16} />
                              </button>
                              <button
              ...
              <div className="space-y-6">
                {isLoadingCollabs ? (
                  ...
                  collaborations.slice(0, 3).map((collab: any) => (
                    <div
                      key={collab._id}
                      className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-5 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-white/5"
                    >
                      <div className="flex items-center gap-4">
                        {collab.advertiser?.profilePicture ? (
                          ...
                          <div className="w-12 h-12 bg-primary-blue/10 rounded-xl flex items-center justify-center text-primary-blue font-bold">
                            {collab.advertiser?.username?.[0] || "A"}
                          </div>
                        )}
                        <div>
                          <h4 className="text-sm font-bold text-gray-900 dark:text-white">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <Card title="Wallet Summary">
              <div className="p-6 bg-gray-900 dark:bg-white dark:text-black rounded-3xl text-white relative overflow-hidden mb-6">
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary-blue/20 rounded-full blur-2xl -mr-16 -mt-16"></div>
                <p className="text-white/60 dark:text-black/60 text-[10px] font-bold uppercase tracking-widest mb-1">
                  Available Balance
                </p>
                <h3 className="text-4xl font-black mb-6">
                  {walletData?.balance?.toLocaleString() ?? 0}{" "}
                  <span className="text-xs font-bold">AACP</span>
                </h3>
                <div className="flex justify-between items-end">
                  <div className="space-y-1">
                    <p className="text-white/40 dark:text-black/40 text-[9px] font-bold uppercase tracking-widest">
                      Locked
                    </p>
                  ...
                  <button
                    onClick={() => navigate("/wallet")}
                    className="px-4 py-2 bg-primary-blue text-black rounded-xl text-xs font-bold hover:bg-neutral-border transition-all"
                  >
                    Top Up
                  </button>
                </div>
              ...
              <div className="flex flex-col items-center py-4">
                {trustScoreLoading ? (
                    ...
                    <div className="mt-6 w-full space-y-4">
                      <div className="p-3 bg-gray-50 dark:bg-white/5 rounded-2xl flex items-center gap-3">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                          {trustScoreValue >= 75
                            ? "Strong trust score. Keep it up!"
                            : "Complete your profile to improve your score."}
                        </p>
                      </div>
                      <button
                        onClick={() => navigate("/profile/edit/business")}
                        className="w-full py-3 bg-primary-blue/10 text-primary-blue font-bold rounded-2xl text-xs hover:bg-primary-blue/20 transition-all"
                      >
                        Improve Score
                      </button>
                    </div>
                  ...
                  <div className="text-center py-4">
                    <ShieldCheck
                      className="mx-auto text-gray-200 dark:text-white/10 mb-3"
                      size={40}
                    />
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Complete your profile to generate a trust score
                    </p>
                    <button
                      onClick={() => navigate("/profile/edit/business")}
                      className="mt-4 w-full py-3 bg-primary-blue/10 text-primary-blue font-bold rounded-2xl text-xs hover:bg-primary-blue/20 transition-all"
                    >
                      Complete Profile
                    </button>
                  </div>
            ...
            <Card
              title="AI Matches"
              extra={<Sparkles className="text-cyan-500" size={16} />}
            >
              <div className="space-y-4">
                {isLoadingRecs ? (
                  ...
                  (recsData?.recommendations ?? [])
                    ...
                    .map((rec: any) => (
                      <div
                        key={rec.targetId}
                        className="flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-white/5 transition-all cursor-pointer"
                      >
                        <div className="flex items-center gap-3">
                          <img
                        ...
                        <button className="p-2 bg-primary-blue/10 text-primary-blue rounded-lg hover:bg-primary-blue hover:text-white transition-all">
                          <Plus size={16} />
                        </button>
                      </div>
                    ))
              ...
              <button
                ...
                className="w-full mt-6 py-3 border border-dashed border-gray-200 dark:border-white/10 text-gray-400 text-xs font-bold rounded-2xl hover:border-primary-blue hover:text-primary-blue transition-all"
              >
                View All Matches
              </button>
            </Card>
                ...
                {isLoadingHistory ? (
                  ...
                  realActivity.map((activity) => (
                    <div key={activity.id} className="relative pl-8">
                      <div
                        className={cn(
                          "absolute left-0 top-1 w-6 h-6 rounded-lg flex items-center justify-center bg-white dark:bg-[#1a1a1a] border border-gray-100 dark:border-white/10 z-10 shadow-sm",
                          activity.color,
                        )}
                      >
                        <activity.icon size={12} />
                      </div>
                      <p className="text-xs font-bold text-gray-900 dark:text-white leading-tight mb-1">
                        {activity.text}
                      </p>
            ...
            <Card
              ...
              extra={
                <button
                  ...
                  className="text-[10px] font-bold text-primary-blue hover:underline transition-all"
                >
                  Mark all read
                </button>
              }
            >
              ...
              <button
                ...
                className="w-full mt-6 py-2 text-gray-400 text-xs font-bold hover:text-primary-blue transition-colors"
              >
                View All Messages
              </button>
            </Card>
