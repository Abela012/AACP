            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={5}
                  minLength={20}
                  className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-primary-blue transition-all resize-none"
                  required
                />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl pl-12 pr-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-primary-blue transition-all"
                      required
                    />
                  </div>
                </div>
            ...
            <div className="space-y-6">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedPlatforms.includes(platform)
                          ? "bg-primary-blue text-black border-primary-blue shadow-md shadow-primary-blue/20"
              ...
              <div>
                ...
                <div className="relative max-w-xs">
                  ...
                  <input 
                    ...
                    className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl pl-10 pr-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-primary-blue transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full max-w-xs bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-primary-blue transition-all"
                />
              </div>
            ...
            <button
              ...
              className={cn(
                ...
                isPending 
                  ...
                  : "bg-primary-blue hover:bg-neutral-border shadow-primary-blue/20 hover:shadow-primary-blue/40 hover:-translate-y-0.5"
              )}
            >
              {isPending ? (
