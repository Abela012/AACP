...
export default function AnalyticsPage() {
  ...
  const stats = [
    { label: 'Total Reach', value: '0', trend: '0%', trendType: 'neutral', icon: Users, color: 'text-primary-blue', bgColor: 'bg-neutral-border/15' },
    ...
    { label: 'ROI', value: '0x', trend: '0x', trendType: 'neutral', icon: Target, color: 'text-primary-blue', bgColor: 'bg-primary-blue-light' },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
          ...
          <div className="flex gap-3">
            ...
            <button className="bg-primary-blue text-white px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-2 hover:bg-primary-blue transition-all shadow-lg shadow-neutral-border/25 dark:shadow-none">
              Export Data
            </button>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 bg-white dark:bg-white/5 p-8 rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-sm dark:shadow-none">
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-neutral-border/30 dark:bg-emerald-900/50 rounded-full" />
