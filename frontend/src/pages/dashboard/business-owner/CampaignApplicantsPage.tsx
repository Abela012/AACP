    ...
    <BusinessLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        <section className="bg-white dark:bg-[#111] rounded-[2.5rem] border border-gray-100 dark:border-white/5 shadow-xl overflow-hidden">
          <div className="p-8 md:p-12 border-b border-gray-50 dark:border-white/5 bg-primary-blue/5">
            <div className="flex flex-col md:flex-row justify-between items-start gap-6">
              <div className="space-y-4 max-w-3xl">
                <div className="flex items-center gap-3">
                  <span className="px-3 py-1 bg-primary-blue text-black text-[10px] font-black uppercase tracking-widest rounded-full">
              ...
              <div className="grid grid-cols-2 md:grid-cols-1 gap-4 w-full md:w-auto">
                <div className="bg-white dark:bg-white/5 p-4 rounded-2xl border border-gray-100 dark:border-white/10">
                  ...
                  <p className="text-xl font-black text-primary-blue">${(typeof opportunity?.budget === 'object' ? opportunity?.budget.amount : (opportunity?.budget || 0)).toLocaleString()}</p>
                </div>
                <div className="bg-white dark:bg-white/5 p-4 rounded-2xl border border-gray-100 dark:border-white/10">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start mb-10">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-xs font-bold text-gray-400 mb-6">
                          <span className="flex items-center gap-1.5"><MapPin size={14} className="text-primary-blue" /> {app.advertiser?.location || 'Remote'}</span>
                          <span className="flex items-center gap-1.5"><Mail size={14} className="text-primary-blue" /> {app.advertiser?.email}</span>
                        </div>
                            ...
                            if (applicantAnalysis?.aiInsight) {
                              return (
                                <div className="pt-3 border-t border-gray-200 dark:border-white/10">
                                  <p className="text-[10px] font-black text-primary-blue uppercase tracking-widest mb-1 flex items-center gap-1">
                                  ...
                                  <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                      <a 
                                        ...
                                        target="_blank" 
                                        rel="noreferrer"
                                        className="inline-flex items-center gap-2 text-sm font-bold text-primary-blue hover:text-neutral-border transition-colors bg-neutral-border/15 dark:bg-primary-blue/10 px-4 py-2 rounded-xl"
                                      >
                          ...
                          <>
                              ...
                              <div className="mb-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  ...
                                  {app.advertiser?.profileData?.niches?.map((niche: string, i: number) => (
                                    <span key={`niche-${i}`} className="bg-neutral-border/15 dark:bg-primary-blue/10 text-primary-blue px-3 py-1 rounded-lg text-xs font-bold border border-neutral-border/25 dark:border-primary-blue/20">{niche}</span>
                                  ))}
                                </div>
                              </div>
                            )}
                            ...
                            {app.advertiser?.profileData?.website && (
                              <div>
                                ...
                                <a href={app.advertiser.profileData.website.startsWith('http') ? app.advertiser.profileData.website : `https://${app.advertiser.profileData.website}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-sm font-bold text-primary-blue hover:text-neutral-border transition-colors bg-neutral-border/15 dark:bg-primary-blue/10 px-4 py-2 rounded-xl">
                          ...
                          return (
                            <>
                              ...
                              <div className="text-center p-4 bg-gray-50/50 dark:bg-white/2 rounded-2xl">
                                ...
                                <p className={cn(
                                  "text-sm font-black",
                                  applicantAnalysis.profitable ? "text-primary-blue" : "text-amber-500"
                                )}>
                    ...
                    <div className="text-center mb-4">
                      ...
                      <div className={cn(
                        ...
                        app.status === 'pending' ? "bg-amber-100 dark:bg-amber-500/20 text-amber-600" :
                          app.status === 'accepted' ? "bg-neutral-border/25 dark:bg-primary-blue/20 text-primary-blue" :
                      ...
                      {app.status === 'pending' ? (
                        <>
                          <button
                            ...
                            className="w-full h-14 bg-primary-blue hover:bg-neutral-border text-black font-black rounded-2xl shadow-lg shadow-primary-blue/20 transition-all flex items-center justify-center gap-2"
                          >
        ...
        {toast.show && (
          <motion.div 
            ...
            className={cn(
              ...
              toast.type === 'success' 
                ? "bg-primary-blue text-black border-neutral-border" 
