    ...
    <AdvertiserLayout>
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-white dark:bg-white/5 p-6 rounded-4xl border border-gray-100 dark:border-white/5 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <span className="text-[10px] font-black text-primary-blue uppercase tracking-widest">Accepted</span>
              <div className="w-8 h-8 rounded-lg bg-primary-blue/10 flex items-center justify-center text-primary-blue">
            ...
            <div className="flex items-center justify-between mt-1">
              ...
              <Link to="/advertiser/collaborations" className="text-[10px] font-black text-primary-blue uppercase hover:underline">Manage All</Link>
            </div>
          </div>
                    ...
                    return (
                      <tr key={app._id} className="hover:bg-gray-50/50 dark:hover:bg-white/5 transition-colors group">
                        <td className="px-8 py-6">
                          <p className="text-sm font-bold text-gray-900 dark:text-white group-hover:text-primary-blue dark:group-hover:text-primary-blue transition-colors">{opp.title || 'Untitled Campaign'}</p>
                        ...
                        <td className="px-8 py-6">
                          <span className={cn(
                            ...
                            "bg-neutral-border/15 dark:bg-primary-blue/10 text-primary-blue dark:text-primary-blue"
                          )}>
                            {app.status}
                          </span>
                        </td>
                        ...
                        <td className="px-8 py-6 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <Link to="/messages" className="p-2 text-gray-400 dark:text-gray-500 hover:text-primary-blue dark:hover:text-primary-blue transition-colors">
