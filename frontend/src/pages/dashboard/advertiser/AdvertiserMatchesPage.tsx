    ...
    <AdvertiserLayout>
      <div className="max-w-[1050px] mx-auto pb-24 pt-8 px-4 sm:px-6">
        ...
        <motion.div 
          ...
          className="relative overflow-hidden rounded-[2.5rem] border border-gray-150 dark:border-white/5 bg-gradient-to-br from-primary-blue/[0.06] via-primary-blue/[0.02] to-violet-500/[0.04] p-8 sm:p-10 mb-8"
        >
          <div className="absolute top-0 right-0 w-72 h-72 bg-primary-blue/10 rounded-full blur-[80px] pointer-events-none animate-pulse duration-[8000ms]" />
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center justify-between gap-8 z-10">
            <div className="max-w-xl">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-blue/10 text-primary-blue dark:text-neutral-border text-[10px] font-black uppercase tracking-wider mb-4 border border-primary-blue/20">
              ...
              <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-gray-900 dark:text-white mb-3">
                Discover campaigns that <span className="bg-gradient-to-r from-primary-blue to-teal-400 dark:from-neutral-border dark:to-teal-300 bg-clip-text text-transparent">match you perfectly</span>
              </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/[0.01] focus:border-primary-blue dark:focus:border-primary-blue/50 outline-none text-gray-900 dark:text-white transition-all text-sm shadow-sm focus:shadow-[0_0_20px_rgba(16,185,129,0.06)]"
            />
          </div>
          ...
          <button 
            ...
            className={cn(
              ...
              showFiltersPanel || hasActiveFilters
                ? "bg-primary-blue text-black border-primary-blue hover:bg-neutral-border"
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            selectedPlatform === p
                              ...
                              : "bg-white dark:bg-black/20 text-gray-500 dark:text-gray-400 border-gray-200 dark:border-white/5 hover:border-primary-blue/30 hover:text-primary-blue"
                          )}
                        >
                          {p}
                        </button>
              ...
              return (
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center gap-1.5">
                    {tab === 'Recommended Campaigns' && <Sparkles size={13} className="text-primary-blue" />}
                    ...
                    {isBookmarked && savedJobs.length > 0 && (
                      <span className={cn(
                        ...
                        isActive ? "bg-primary-blue text-black" : "bg-primary-blue/10 text-primary-blue"
                      )}>
                        {savedJobs.length}
                      </span>
                    )}
        ...
        {isLoading ? (
          <div className="flex flex-col items-center py-32">
            <div className="relative mb-4">
              <div className="absolute inset-0 bg-primary-blue/10 rounded-full blur-[10px] pointer-events-none animate-pulse" />
              <Loader2 size={44} className="text-primary-blue animate-spin relative z-10" />
            </div>
          ...
          >
            ...
            {hasActiveFilters && (
              <button 
                ...
                className="mt-6 px-6 py-2.5 bg-gray-200 dark:bg-white/10 hover:bg-primary-blue dark:hover:bg-primary-blue hover:text-black text-gray-700 dark:text-white text-xs font-bold rounded-xl transition-all cursor-pointer"
              >
          ...
          <div className="flex flex-col gap-6">
            <AnimatePresence mode="popLayout">
              {displayOpportunities.map((opp: any, idx: number) => {
                ...
                const gradients = [
                  'from-neutral-border to-teal-500',
                ...
                return (
                  <motion.div
                    ...
                    className={cn(
                      ...
                      "hover:border-primary-blue/30 dark:hover:border-primary-blue/20 hover:shadow-[0_20px_50px_rgba(16,185,129,0.03)] dark:hover:shadow-[0_20px_50px_rgba(16,185,129,0.06)] hover:-translate-y-1"
                    )}
                  >
                    {/* Glow Accents */}
                    {score && score >= 85 && (
                      <div className="absolute top-0 left-0 w-[4px] h-full bg-primary-blue" />
                    )}
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <Link to={`/advertiser/matches/${opp._id}/apply`}>
                          <h3 className="text-xl font-black text-gray-900 dark:text-white hover:text-primary-blue dark:hover:text-neutral-border transition-colors line-clamp-2 leading-snug">
                            {opp.title}
                          </h3>
                        </Link>
                      </div>
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300 mb-6 leading-relaxed bg-gray-50/20 dark:bg-white/[0.005] p-4 rounded-2xl border border-gray-100/50 dark:border-white/5">
                      ...
                      {opp.description && opp.description.length > 200 && (
                        <button
                          ...
                          className="text-primary-blue hover:text-neutral-border font-black text-xs mt-3 flex items-center gap-0.5 transition-colors cursor-pointer focus:outline-none"
                        >
                        ...
                        return (
                          <span
                            ...
                            className={cn(
                              ...
                              !isInstagram && !isTikTok && !isYouTube && "bg-primary-blue/10 text-primary-blue border-primary-blue/20 dark:bg-primary-blue/5"
                            )}
                          >
                            <span className={cn(
                              ...
                              !isInstagram && !isTikTok && !isYouTube && "bg-primary-blue animate-pulse"
                            )} />
                            {platform}
                          </span>
                        );
                    ...
                    {roundedScore !== undefined && (
                      <div className={cn(
                        ...
                        roundedScore >= 70
                          ? "bg-primary-blue/[0.03] dark:bg-primary-blue/[0.01] border-primary-blue/15 text-gray-600 dark:text-gray-300"
                          : roundedScore >= 45
                        ...
                        {roundedScore >= 70 ? (
                          <>
                            <div className="flex items-center gap-1.5">
                              <Check className="text-primary-blue" size={13} />
                      ...
                      <div className="flex justify-between sm:justify-end items-center gap-4 mt-2 lg:mt-0">
                        ...
                        <div className="flex items-center gap-3">
                          <div className="text-right hidden sm:block">
                            ...
                            <span className="text-base font-black text-primary-blue">{budgetAmount.toLocaleString()} ETB</span>
                          </div>
                          ...
                          {hasApplied(opp._id) ? (
                            ...
                            <Link to={`/advertiser/matches/${opp._id}/apply`}>
                              <button className="px-6 py-3.5 bg-primary-blue hover:bg-neutral-border text-black text-xs font-black rounded-2xl shadow-lg shadow-primary-blue/10 hover:shadow-primary-blue/25 transition-all duration-300 flex items-center gap-1.5 group cursor-pointer">
                                Apply to Match
