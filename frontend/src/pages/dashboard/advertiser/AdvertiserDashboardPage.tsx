      ...
      <main className="p-4 sm:p-8 max-w-[1400px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {applications.map((app, idx) => (
                  <div key={idx} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-5 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 hover:border-gray-200 dark:hover:border-white/10 transition-all group gap-4">
                    ...
                    <div className="flex items-center justify-between w-full sm:w-auto gap-8">
                      ...
                      <span className={cn("px-3 py-1 rounded-lg text-[10px] font-bold tracking-wider", app.statusColor)}>
                        {app.status}
                      </span>
                    </div>
                  </div>
          ...
          <div className="space-y-8">
            {/* Match Analysis */}
            <div
              className={cn("bg-white dark:bg-white/5 p-8 rounded-[2.5rem] border border-gray-100 dark:border-white/5 relative shadow-sm dark:shadow-none", !isApproved && "opacity-50 pointer-events-none")}
            >
              {!isApproved && (
                <div className="absolute inset-0 z-10 flex items-center justify-center bg-white/40 dark:bg-black/40 backdrop-blur-[2px] rounded-[2.5rem]">
                  <div className="bg-white dark:bg-[#1a1a1a] p-4 rounded-2xl shadow-xl border border-gray-100 dark:border-white/10 flex items-center gap-3">
              ...
              <div className="bg-gray-50 dark:bg-white/5 p-5 rounded-2xl border border-gray-100 dark:border-white/5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-[10px] font-bold text-cyan-500 uppercase tracking-widest">Recommendation</span>
                </div>
                <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                  Your profile shows strong resonance with "Tech Enthusiast" demographics. Aim for high-engagement video assets to increase ROI by an estimated 14%.
                </p>
              </div>
            </div>

            {/* Recent Partner Reviews */}
            <div className={cn("bg-white dark:bg-white/5 p-8 rounded-[2.5rem] border border-gray-100 dark:border-white/5 relative shadow-sm dark:shadow-none", !isApproved && "opacity-50 pointer-events-none")}>
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-8">Recent Partner Reviews</h3>
              <div className="space-y-8">
                {reviews.map((review, idx) => (
                  <div key={idx} className="space-y-3">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase">{review.time}</span>
                    </div>
