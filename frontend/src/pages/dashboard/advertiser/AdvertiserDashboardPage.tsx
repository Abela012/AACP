...
export default function AdvertiserDashboardPage() {
  ...
  const stats = [
    { label: 'Trust Score', value: 'N/A', subValue: '', trend: 'New Account', trendType: 'neutral', icon: ShieldCheck, color: 'text-primary-blue' },
        ...
        {onboardingStatus === 'incomplete' ? (
          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-4">
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-gray-900 dark:text-white">Dashboard <span className="text-primary-blue">Overview</span></h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
              {stats.map((stat, idx) => (
                ...
                >
                  ...
                  <div className={cn(
                    "text-xs font-medium",
                    stat.trendType === 'up' ? "text-primary-blue" : "text-gray-500"
                  )}>
                    {stat.trend}
                  </div>
                </button>
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap items-center gap-2 mb-4">
                              ...
                              <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-neutral-border/15 dark:bg-primary-blue/10 text-primary-blue dark:text-neutral-border text-xs font-semibold border border-neutral-border/25/30 dark:border-primary-blue/10">
                                <Briefcase size={12} className="text-primary-blue" />
