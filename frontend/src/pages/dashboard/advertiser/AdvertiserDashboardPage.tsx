...
export default function AdvertiserDashboardPage() {
  ...
  const stats = [
    {
      ...
      trend:
        trustScoreValue !== null
          ...
          : "No data yet",
      trendType:
        trustScoreValue !== null && trustScoreValue >= 70 ? "up" : "neutral",
      icon: ShieldCheck,
  ...
  const handleStatClick = (label: string) => {
    ...
    if (label.includes("Trust")) {
      navigate("/profile/edit/advertiser");
      return;
    }
  ...
  return (
    <AdvertiserLayout>
      <main className="p-4 sm:p-8 max-w-[1400px] mx-auto w-full">
        <div className="mb-8 p-4 bg-gray-50 dark:bg-white/5 rounded-2xl  flex-wrap items-center gap-4 border border-gray-100 dark:border-white/10 hidden"></div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-4">
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-gray-900 dark:text-white">
                  Dashboard <span className="text-primary-blue">Overview</span>
                </h1>
                <p className="text-gray-500 dark:text-gray-400 text-sm">
                  Welcome back, {clerkUser?.firstName || "User"}. Explore the
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
              {stats.map((stat, idx) => (
                <button
                  ...
                  className="w-full text-left bg-white dark:bg-white/5 p-6 rounded-4xl border border-gray-100 dark:border-white/5 hover:border-primary-blue/30 transition-all group shadow-sm dark:shadow-none"
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div
                      className={cn(
                        "w-10 h-10 bg-gray-50 dark:bg-white/5 rounded-xl flex items-center justify-center",
                        stat.color,
                      )}
                    >
                      <stat.icon size={20} />
              ...
              >
                {isLoadingOpps ? (
                  <div className="flex flex-col items-center py-20">
                    <Loader2
                      size={40}
                      className="text-primary-blue animate-spin mb-4"
                    />
                  ...
                  opportunities.slice(0, 6).map((opp: any, idx: number) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="mb-6 p-6 sm:p-8 bg-white dark:bg-[#181a20]/40 rounded-[2rem] border border-gray-100 dark:border-white/[0.05] hover:border-primary-blue/30 dark:hover:border-primary-blue/30 shadow-sm dark:shadow-none hover:shadow-xl hover:shadow-primary-blue/[0.03] transition-all duration-300 group flex flex-col lg:flex-row gap-6 items-start lg:items-stretch justify-between relative overflow-hidden backdrop-blur-md"
                      >
                        <div className="flex-1 flex flex-col justify-between">
                          <div>
                            ...
                            <div className="flex flex-wrap items-center gap-2 mb-4">
                              ...
                              <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-neutral-border/15 dark:bg-primary-blue/10 text-primary-blue dark:text-neutral-border text-xs font-semibold border border-neutral-border/25/30 dark:border-primary-blue/10">
                                <Briefcase
                                  size={12}
                                  className="text-primary-blue"
                                />
                            ...
                            <div
                              ...
                              className="cursor-pointer group-hover:text-primary-blue dark:group-hover:text-neutral-border transition-colors"
                            >
                              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white leading-snug line-clamp-2 mb-2 group-hover:text-primary-blue dark:group-hover:text-neutral-border transition-colors">
                                {opp.title}
                              </h3>
                            </div>
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap items-center gap-y-2 gap-x-5 text-xs font-semibold text-gray-500 dark:text-gray-400 pt-4 border-t border-gray-100 dark:border-white/[0.05]">
                              ...
                              <div className="flex items-center gap-0.5 text-yellow-500">
                                {[...Array(5)].map((_, i) => {
                                  const rating =
                                    opp.businessOwner?.averageRating || 0;
                        ...
                        <div className="flex sm:flex-row lg:flex-col items-center sm:items-center lg:items-end justify-between lg:justify-center w-full lg:w-auto shrink-0 border-t lg:border-t-0 lg:border-l border-gray-100 dark:border-white/[0.05] pt-5 lg:pt-0 lg:pl-8 lg:min-w-[220px] gap-4">
                          ...
                          <div className="flex items-center gap-2.5 w-full sm:w-auto lg:w-full mt-2 sm:mt-0 lg:mt-4">
                            <button
                              ...
                              className="flex-1 px-5 py-3 bg-primary-blue hover:bg-primary-blue text-white text-sm font-bold rounded-2xl transition-all duration-300 shadow-md shadow-primary-blue/10 hover:shadow-lg hover:shadow-primary-blue/20 flex items-center justify-center gap-2 group/btn active:scale-95"
                            >
                              <span>Details</span>
                              <ArrowRight
                                size={14}
                  ...
                  <div className="col-span-full py-20 text-center">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">
                      Check back later for new brand campaigns.
                    </p>
                  </div>
                )}
              </div>
