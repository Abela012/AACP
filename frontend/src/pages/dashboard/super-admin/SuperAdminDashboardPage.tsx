        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((c, idx) => (
            <motion.button
              ...
              className="text-left aacp-cx aacp-cx--admin p-6 hover:shadow-md transition-all group"
            >
              <div className="flex items-start justify-between mb-6">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${c.bg} ${c.color} border ${c.border}`}>
                  <c.icon size={20} />
                </div>
                <div className="text-[#9A9FA5] group-hover:text-primary-blue transition-colors">
                  <ArrowRight size={18} />
                </div>
              </div>
