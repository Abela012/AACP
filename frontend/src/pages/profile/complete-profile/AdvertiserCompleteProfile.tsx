  ...
  if (loading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-3">
        <Loader2 size={36} className="text-primary-blue animate-spin" />
    ...
    <div className="max-w-4xl mx-auto px-4 pb-32 space-y-8">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-primary-blue/10 dark:bg-primary-blue/20 flex items-center justify-center text-primary-blue dark:text-neutral-border">
            <Sparkles size={20} />
          </div>
          <div>
        ...
        <div className="flex-1 max-w-md flex items-center gap-3">
          <div className="flex-1 h-2 rounded-full bg-gray-100 dark:bg-white/10 overflow-hidden">
            <motion.div
              className="h-full bg-linear-to-r from-primary-blue to-teal-400 rounded-full"
              animate={{ width: `${progressPercent()}%` }}
              transition={{ duration: 0.5, ease: "easeOut" }}
            />
          </div>
          <span className="text-xs font-black text-primary-blue dark:text-neutral-border min-w-8 text-right">{progressPercent()}%</span>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          <span className="text-primary-blue bg-primary-blue/10 p-2 rounded-xl"><User size={20} /></span>
          <div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              />
              {firstName.trim() !== '' && (
                <span className="absolute right-3 top-1/2 -translate-y-1/2 text-primary-blue"><Check size={18} /></span>
              )}
            </div>
          </div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          <span className="text-primary-blue bg-primary-blue/10 p-2 rounded-xl"><Link size={20} /></span>
          <div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-gray-50 dark:bg-[#151515] border border-gray-100 dark:border-white/5 rounded-2xl p-5 flex flex-col justify-between min-h-[170px] relative overflow-hidden transition-all hover:border-primary-blue/20">
            <div>
              ...
              {connectedAccounts.tiktok.connected && connectedAccounts.tiktok.verified ? (
                <div className="mt-2 space-y-1">
                  <p className="text-xs font-semibold text-primary-blue dark:text-neutral-border">@{connectedAccounts.tiktok.username}</p>
            ...
            <div className="mt-4">
              {connectedAccounts.tiktok.connected && connectedAccounts.tiktok.verified ? (
                <button
                  disabled
                  className="w-full text-xs font-bold py-2.5 bg-primary-blue/10 text-primary-blue dark:text-neutral-border rounded-xl cursor-not-allowed flex items-center justify-center gap-1.5"
                >
                ...
                <button
                  ...
                  className="w-full text-xs font-bold py-2 bg-primary-blue text-white hover:bg-neutral-border rounded-xl transition-all shadow-md shadow-primary-blue/15"
                >
                  Connect Account
                </button>
              )}
      ...
      <AnimatePresence mode="wait">
        {isAnySocialConnected ? (
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <span className="text-primary-blue bg-primary-blue/10 p-2 rounded-xl"><Target size={20} /></span>
              <div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-gray-50 dark:bg-[#181818] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-primary-blue focus:ring-1 focus:ring-primary-blue/30 transition-all cursor-pointer"
                >
              ...
              <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-white/5">
                <h4 className="text-xs font-bold text-primary-blue dark:text-neutral-border uppercase tracking-widest flex items-center gap-1.5"><Globe size={14} /> Demographics of your Audience</h4>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full bg-gray-50 dark:bg-[#181818] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 text-xs text-gray-900 dark:text-white focus:outline-none focus:border-primary-blue transition-all"
                    >
                ...
                <div className="space-y-3">
                  ...
                  <form onSubmit={handleAddInterest} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-gray-50 dark:bg-[#181818] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 text-xs text-gray-900 dark:text-white focus:outline-none focus:border-primary-blue transition-all"
                    />
                    <button
                      type="submit"
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-primary-blue/5 border border-primary-blue/10 rounded-3xl p-6 text-center text-sm text-gray-500 dark:text-gray-400"
          >
            🔒 <span className="font-bold text-primary-blue dark:text-neutral-border">Niche & Content Customizer:</span> Please connect at least one social media account above to unlock Niche selection.
          </motion.div>
        )}
      </AnimatePresence>
      ...
      >
        <button
          ...
          className={`w-full md:w-auto md:min-w-[280px] flex items-center justify-center gap-2 font-black py-4 px-8 rounded-2xl transition-all duration-300 text-sm tracking-wide ${isFormValid
              ? "bg-linear-to-r from-primary-blue to-teal-500 hover:from-neutral-border hover:to-teal-400 text-white shadow-lg shadow-primary-blue/25 cursor-pointer scale-100 hover:scale-[1.01]"
            ...
            >
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-gray-400 dark:text-gray-500 leading-normal">
                      💡 Tip: Use a mock account handle like <span className="font-semibold text-primary-blue dark:text-neutral-border">@tiktok_star</span>, <span className="font-semibold text-primary-blue dark:text-neutral-border">@instagram_star</span>, or <span className="font-semibold text-primary-blue dark:text-neutral-border">@facebook_star</span> to skip real Apify bio verification during development testing.
                    </p>
                  </div>
                  <button
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 dark:bg-[#181818] border border-gray-100 dark:border-white/5 rounded-2xl p-5 text-center space-y-3 relative">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      ...
                      >
                        {copied ? <Check size={14} className="text-primary-blue" /> : <Copy size={14} />}
                      </button>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <span className="w-6 h-6 rounded-full bg-primary-blue/10 text-primary-blue font-bold text-xs flex items-center justify-center shrink-0">1</span>
                      <p className="text-xs text-gray-500 dark:text-gray-400 leading-normal">
                        Copy the generated 10-character code above.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="w-6 h-6 rounded-full bg-primary-blue/10 text-primary-blue font-bold text-xs flex items-center justify-center shrink-0">2</span>
                      <p className="text-xs text-gray-500 dark:text-gray-400 leading-normal">
                        Go to your {modalPlatform} profile settings.
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="w-6 h-6 rounded-full bg-primary-blue/10 text-primary-blue font-bold text-xs flex items-center justify-center shrink-0">3</span>
                      <p className="text-xs text-gray-500 dark:text-gray-400 leading-normal">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 font-bold py-3.5 bg-primary-blue text-white rounded-2xl text-xs hover:bg-neutral-border transition-all shadow-md shadow-primary-blue/15"
                    >
                      Code is Added
                    </button>
                  </div>
              ...
              {modalStep === 3 && (
                <div className="space-y-6 text-center">
                  <div className="w-16 h-16 rounded-full bg-primary-blue/10 flex items-center justify-center mx-auto text-primary-blue mb-2">
                    <HelpCircle size={28} />
                  </div>
                  <div>
                  ...
                  {verifying ? (
                    <>
                      <div className="relative w-20 h-20 mx-auto">
                        ...
                        <div className="absolute inset-2 rounded-full bg-primary-blue/5 flex items-center justify-center text-primary-blue animate-pulse">
                          <Globe size={24} />
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        <h5 className="font-bold text-gray-900 dark:text-white text-sm">Bio Scanning Protocol</h5>
                        <p className="text-xs text-primary-blue dark:text-neutral-border font-semibold">{scanMessage}</p>
                      </div>
                    </>
                  ) : (
                    <>
                      <div className="w-16 h-16 rounded-full bg-primary-blue/10 text-primary-blue flex items-center justify-center mx-auto mb-2 animate-bounce">
                        <Check size={32} />
                      </div>
                      <div>
                        <h5 className="font-bold text-gray-900 dark:text-white capitalize">{modalPlatform} Verified!</h5>
                        <p className="text-xs text-primary-blue dark:text-neutral-border font-semibold mt-1">
