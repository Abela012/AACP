  ...
  return (
    <motion.div className="space-y-1.5" initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <input
        ...
        className="w-full bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-sm focus:border-primary-blue focus:ring-1 focus:ring-primary-blue/30 outline-none"
      />
  ...
  return (
    <div className="space-y-1.5">
      ...
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="w-full bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-sm focus:border-primary-blue outline-none"
      >
        {options.map((o) => (
