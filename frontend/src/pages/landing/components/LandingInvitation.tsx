    ...
    <section id="invite" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-12">
        <motion.div
          ...
          className="relative overflow-hidden border border-aacp-olive/30 bg-gradient-to-br from-aacp-gold/45 via-aacp-cream to-aacp-parchment px-8 py-14 sm:px-14 sm:py-18"
        >
          <div className="pointer-events-none absolute -right-16 top-0 h-56 w-56 rotate-12 bg-aacp-olive/12 blur-3xl" />
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.15fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 aacp-font-display text-[clamp(2rem,5vw,3.5rem)] leading-[1.08] text-aacp-ink">
                Post an opportunity or apply with your profile.
              </h2>
              <p className="mt-5 max-w-xl text-sm leading-relaxed text-aacp-smoke sm:text-base">
