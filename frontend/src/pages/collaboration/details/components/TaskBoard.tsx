      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {userRole === 'business_owner' && (
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-500/20"
          >
            <Plus size={18} />
            Create Task
          </button>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                  <div className={cn(
                    ...
                    task.status === 'approved' ? "bg-emerald-50 dark:bg-emerald-500/10" : "bg-gray-50 dark:bg-white/5"
                  )}>
