      ...
      <div className="relative z-10">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1 flex items-center gap-2">
                {campaign?.category || "General"} Campaign{" "}
                <ChevronRight size={14} /> Influencer Partnership
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-2xl font-black text-gray-900 dark:text-white">
                {collaboration?.agreedBudget?.amount?.toLocaleString() || "0"}{" "}
                <span className="text-sm font-bold text-primary-blue">
                  {collaboration?.agreedBudget?.currency || "ETB"}
                </span>
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-gray-50/50 dark:bg-white/[0.02] rounded-2xl border border-gray-100 dark:border-white/5">
            ...
            <p className="text-lg font-black text-gray-900 dark:text-white">
              {collaboration?.tasks?.filter((t: any) => t.status !== "approved")
                .length || 0}
            </p>
          </div>
        </div>
