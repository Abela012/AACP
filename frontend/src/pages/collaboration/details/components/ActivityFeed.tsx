...
export const ActivityFeed: React.FC<{ activities: ActivityItem[] }> = ({ activities }) => {
  const getIcon = (type: string) => {
    switch (type) {
      case 'acceptance': return <UserCheck className="text-emerald-500" size={16} />;
      ...
      case 'task_approved': return <CheckCircle2 className="text-emerald-500" size={16} />;
      ...
      case 'payment_released': return <DollarSign className="text-emerald-600" size={16} />;
