...
export const DeliverablesManager: React.FC<DeliverablesManagerProps> = ({ deliverables, userRole, onUpload, onAction }) => {
  ...
  const getStatusStyle = (s: string) => {
    switch (s) {
      case 'approved': return 'bg-primary-blue/10 text-primary-blue border-neutral-border/30';
  ...
  const getFileIcon = (type: string) => {
    ...
    if (type.includes('video')) return <Video size={24} className="text-primary-blue" />;
            ...
            >
              ...
              <div className="p-6">
                 <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-[10px] font-black text-primary-blue bg-neutral-border/15 dark:bg-primary-blue/10 px-2 py-1 rounded-lg border border-neutral-border/25 dark:border-primary-blue/10 uppercase tracking-tighter">
                      LATEST
                    </span>
                 </div>
                 ...
                 <div className="flex gap-2">
                    ...
                    {userRole === 'business_owner' && item.status === 'pending' && (
                      <button 
                        ...
                        className="flex-1 py-2.5 bg-primary-blue text-white text-xs font-bold rounded-xl hover:bg-primary-blue transition-all shadow-lg shadow-primary-blue/20"
                      >
                        Review
                      </button>
                    )}
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <label 
                  ...
                  className="block border-2 border-dashed border-gray-200 dark:border-white/10 rounded-2xl p-10 text-center hover:border-primary-blue transition-all cursor-pointer group"
                >
                   <div className="w-12 h-12 bg-primary-blue/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                      {uploadData.file ? <Check className="text-primary-blue" size={24} /> : <Upload className="text-primary-blue" size={24} />}
                   </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-2 pt-2">
                  <button 
                    ...
                    className="w-full py-3 bg-primary-blue text-white font-bold rounded-xl hover:bg-primary-blue shadow-lg shadow-primary-blue/20 flex items-center justify-center gap-2"
                  >
                    ...
                    {userRole === 'business_owner' && isPreviewing.status === 'pending' ? (
                      <div className="space-y-3">
                        <button 
                          ...
                          className="w-full py-4 bg-primary-blue text-white font-black rounded-2xl hover:bg-primary-blue transition-all shadow-xl shadow-primary-blue/20 flex items-center justify-center gap-2"
                        >
                          Review & Action
                        </button>
                        <button 
