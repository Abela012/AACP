          ...
          >
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 font-medium leading-relaxed max-w-xs mx-auto">
                You are about to mark your collaboration with{" "}
...
export default function CollaborationsPage() {
  ...
  const filteredCollaborations = (collaborations ?? []).filter(
    (c: Collaboration) => {
      ...
      const matchesSearch =
        !searchLower || title.toLowerCase().includes(searchLower);
  ...
  const handleConfirmComplete = async () => {
    ...
    try {
      ...
      setConfirmModal(null);
      setToast({
        message: err.message || "Failed to complete collaboration",
        type: "error",
      });
    }
  };
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">
              Manage your active projects and track your performance.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          {isLoading ? (
            ...
            filteredCollaborations.map((c: Collaboration) => {
              const partner =
                userRole === "business_owner" ? c.advertiser : c.businessOwner;
              const partnerName =
                  ...
                  <div className="flex flex-col lg:flex-row">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm font-black text-gray-900 dark:text-white">
                            {c.agreedBudget?.amount?.toLocaleString() || "0"}{" "}
                            {c.agreedBudget?.currency || "AACP"}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-8 lg:w-1/3 bg-gray-50/30 dark:bg-white/[0.01] flex flex-col justify-center gap-3">
                            ...
                            <button
                              onClick={(e) => {
                                ...
                                setReviewModal({
                                  ...
                                  opportunityId: c.opportunity?._id,
                                });
                              }}
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate(`/messages?collab=${c._id}`);
                        }}
            ...
            <div className="text-center py-20 bg-white dark:bg-white/5 rounded-[3rem] border-2 border-dashed border-gray-100 dark:border-white/5">
              ...
              <p className="text-sm text-gray-500 max-w-xs mx-auto mt-2 font-medium">
                Once you start a collaboration with a creator or brand, it will
